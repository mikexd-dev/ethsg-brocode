            ...
            <DialogContent className="max-w-[800px] bg-gray-100 pt-12">
                <DialogHeader className="flex w-full flex-row">
                    <div className="flex w-2/3 items-center">
                        ...
                        <div>
                            <p className="text-2xl font-semibold text-gray-800">{charity.npo}</p>
                            <p className="text-md text-gray-700 my-2">{charity.url}</p>
                            <p className="text-md text-gray-700 font-semibold">S$8.3K raised | 3 open proposals</p>
                        </div>
                    </div>
                            ...
                            <DialogDescription className="border border-[1] rounded-md p-4">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="flex gap-4">
                                        {charity.impact.map(impact => {
                                            return <div className="bg-gray-200 rounded p-2 w-1/3">
                        ...
                        <DialogDescription>
                            <DialogDescription className="border border-[1] rounded-md p-4">
                                <div className="mb-6">
                                    ...
                                    <div className="flex gap-4">
                                        <div
                                            className="bg-white rounded-lg p-4 my-4 w-1/3"
                                        >
