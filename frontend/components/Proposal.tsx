        ...
        <DialogHeader className="flex flex-row gap-5">
          <div className="flex flex-col w-2/3">
            ...
            <div className="flex flex-row items-center gap-2 pt-3 mb-2">
              ...
              <DialogDescription className="text-sm text-gray-800">{proposal.npo}</DialogDescription>
            </div>
            <img
              src="/howtovote.svg"
              alt="howtovote"
          ...
          <div className="flex flex-col overflow-hidden rounded-lg w-1/3">
            <div className="bg-white p-2">
              <div className="flex flex-row items-center justify-between mb-2">
                ...
                <div className="text-gray-800 font-semibold">{proposal.ask}</div>
              </div>
              ...
              <div className="flex flex-row gap-2 justify-between py-2">
                ...
                <Button variant="destructive" className="py-0 w-1/2" size="sm">
                  Reject
                </Button>
              </div>
            </div>
        ...
        <DialogDescription className="border border-[1] rounded-md p-4">
          ...
          <div className="bg-white p-4 rounded-lg">
            <div className="flex flex-row justify-between pb-2">
              ...
              <div className="text-gray-800 font-semibold text-xl">{proposal.vendor.amount}</div>
            </div>
